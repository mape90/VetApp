...
#
# Created: Wed Aug  5 20:15:35 2015
...
class Ui_Visit(object):
    def setupUi(self, Visit):
        ...
        self.label_7 = QtGui.QLabel(Visit)
        self.label_7.setMaximumSize(QtCore.QSize(16777215, 30))
        self.label_7.setObjectName(_fromUtf8("label_7"))
        self.horizontalLayout_14.addWidget(self.label_7)
        self.reasonTextEdit = QtGui.QTextEdit(Visit)
        self.reasonTextEdit.setMaximumSize(QtCore.QSize(16777215, 29))
        self.reasonTextEdit.setWhatsThis(_fromUtf8(""))
        self.reasonTextEdit.setAccessibleDescription(_fromUtf8(""))
        self.reasonTextEdit.setTabChangesFocus(True)
        self.reasonTextEdit.setDocumentTitle(_fromUtf8(""))
        self.reasonTextEdit.setLineWrapMode(QtGui.QTextEdit.WidgetWidth)
        self.reasonTextEdit.setLineWrapColumnOrWidth(0)
        self.reasonTextEdit.setObjectName(_fromUtf8("reasonTextEdit"))
        self.horizontalLayout_14.addWidget(self.reasonTextEdit)
        ...
        spacerItem8 = QtGui.QSpacerItem(17, 0, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
    ...
    def retranslateUi(self, Visit):
        ...
        self.label_7.setText(_translate("Visit", "Käynnin syy", None))
        self.reasonTextEdit.setToolTip(_translate("Visit", "Tämä tulee näkymään käyntiä haettaessa", None))
